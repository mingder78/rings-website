...
import { shanImages, shanLayouts } from "../constances";
    ...
    <div className="font-ebgaramond flex min-h-screen bg-background text-foreground md:pl-60">
      ...
      <main className="flex-1 sm:px-12 md:px-4">
        <div className="py-6 sm:py-12 px-8  space-y-12 bg-slate-0">
              ...
              <div>
                <p className="text-sm leading-relaxed space-y-2">
                  <em>
                    ...
                    interweave and present how Shan (mountain) and Shu (tree)
                    surround, merge and reflect the spatial and natural scenes
                    of local life and belief.
                  </em>
                </p>
              </div>
            </div>
                ...
                <section className="space-y-4 text-sm leading-relaxed">
                  <p>
                    ...
                    <strong className="font-ebgaramond">
                      “When you climb up on the hill, walk through the wooden
                      paths, step on stone stairs, you already started the
          ...
          <CarouselGallery images={shanImages} layouts={shanLayouts} />
          <p className="text-xs text-muted-foreground pt-12 border-t border-border"></p>
          {/* Footer */}
          <ImageLinksComponent />
